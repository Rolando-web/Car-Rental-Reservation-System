  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex items-center space-x-8">
        ...
        <a href="index.php#cars" class="text-gray-700 hover:text-blue-600 font-medium">Cars</a>
        <a href="bookings.php" class="text-gray-700 hover:text-blue-600 font-medium">My Bookings</a>
